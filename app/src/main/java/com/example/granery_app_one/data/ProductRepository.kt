...
class ProductRepository(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName:String, number:String, productQuantity:String, productPrice:String){
        var id = System.currentTimeMillis().toString()
        var productData = Product(productName,number,productQuantity,productPrice,id)
